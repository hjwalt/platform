...
func NewConsumer(configuration RabbitConfiguration, handler message.Handler[RabbitMetadata, structure.Bytes]) message.Consumer[RabbitMetadata] {
...
type RabbitConsumer struct {
	...
	QueueName        string
	QueueDurable     bool
	Handler          message.Handler[RabbitMetadata, structure.Bytes]
...
func (r *RabbitConsumer) Loop(ctx context.Context, cancel context.CancelFunc) error {
	...
	t := message.Message[RabbitMetadata, structure.Bytes]{
		Id: "",
