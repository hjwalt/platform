...
Web Component Spec: Chat Item

# High Level Description

Define the behavior, rendering contract, and composition boundaries for the web/component/component_chat_item web component so it can be used consistently across pages and higher-level layouts.
