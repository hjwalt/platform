...
### FR-WEB-PAGE-00002-001 Route Registration
...
### FR-WEB-PAGE-00002-002 Page Rendering and Context Loading
...
### FR-WEB-PAGE-00002-003 Message Submission Behavior
...
### FR-WEB-PAGE-00002-004 Tool Decision Behavior
...
### FR-WEB-PAGE-00002-005 Reset Chat History Behavior
...
## NFR-WEB-PAGE-00002-001 Determinism
- Route behavior is deterministic for identical request payloads.

## NFR-WEB-PAGE-00002-002 Isolation
- Handler logic remains isolated to web/page/page_chat without global mutable state.

## NFR-WEB-PAGE-00002-003 HTMX Compatibility
- Chat rendering and post handlers remain compatible with HTMX form interaction patterns in page.html.

## NFR-WEB-PAGE-00002-004 Idempotency
- Reset interactions are idempotent so repeated resets do not produce inconsistent state.
